...
/**
 * Called when the camera controller recognize a facial gesture
 *
 * @param cameraController
 *
 * @param facialGestureType
 */
- (void)cameraController:(id<FastttCameraInterface>)cameraController didRegisterFacialGestureOfType:(FCGestureType)facialGestureType;

/**
 * Called when the camera controller update the progress of recognizing a facial gesture
 *
 * @param cameraController
 *
 * @param progress
 ...
 * @param facialGestureType
 */
- (void)cameraController:(id<FastttCameraInterface>)cameraController didUpdateFacialGestureProgress:(float)progress forType:(FCGestureType)facialGestureType;
@end
